...
namespace VirtualCompress.Tool
{
    internal sealed class CRC
    {
        ...
        public static byte[] Crc32ByteForPath(string path)
        {
            return BitConverter.GetBytes(Crc32ForPath(path));
        }

        internal static uint Crc32ForPath(string path)
        {
        ...
        internal static byte[] Crc32BytesForPath(string path)
        {
            return BitConverter.GetBytes(Crc32ForPath(path));
        }
